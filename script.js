...
const skills = {
  Frontend: [
    { name: "React", icon: "/images/skills/react.png", level: 5 },
    { name: "JavaScript", icon: "/images/skills/javascript.png", level: 5 },
    { name: "TypeScript", icon: "/images/skills/typescript.png", level: 4 },
    { name: "HTML5", icon: "/images/skills/html5.png", level: 5 },
    { name: "CSS3", icon: "/images/skills/css3.png", level: 5 },
  ],
  Backend: [
    { name: "Node.js", icon: "/images/skills/nodejs.png", level: 4 },
    { name: "Express", icon: "/images/skills/express.png", level: 4 },
    { name: "MongoDB", icon: "/images/skills/mongodb.png", level: 3 },
  ],
  Tools: [
    { name: "Git", icon: "/images/skills/git.png", level: 4 },
    { name: "Docker", icon: "/images/skills/docker.png", level: 3 },
  ],
}
